...
START_DATE = pendulum.datetime(2026, 7, 29, 0, 0, 0, tz="America/Sao_Paulo")
...
@task()
def task_ouro(silver_key: str, symbol: str) -> str | None:
    return executar_ouro(silver_key, symbol)


@task()
def task_crawler(ouro_keys: list[str | None]) -> list[str]:
